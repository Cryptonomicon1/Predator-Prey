...
p.axvline(copper_t - stone_t, color='#33adff', lw=line_width, label='copper ages: '+s)
s = str(bronze_t - stone_t)
p.axvline(bronze_t - stone_t, color='#0099ff', lw=line_width, label='bronze ages: '+s)
s = str(iron_t - stone_t)
p.axvline(iron_t - stone_t, color='#007acc', lw=line_width, label='iron ages: '+s)
s = str(org_t - stone_t)
p.axvline(org_t - stone_t, color='#005c99', lw=line_width, label='order ages: '+s)
s = str(medieval_t - stone_t)
p.axvline(medieval_t - stone_t, color='#003d66', lw=line_width, label='middle ages: '+s)
