...
p.axvline(copper_t - stone_t, color='#33adff', lw=line_width, label='copper age: 1300')
p.axvline(bronze_t - stone_t, color='#0099ff', lw=line_width, label='bronze age: 6700')
p.axvline(iron_t - stone_t, color='#007acc', lw=line_width, label='iron age: 8800')
p.axvline(org_t - stone_t, color='#005c99', lw=line_width, label='org age: 9970')
p.axvline(medieval_t - stone_t, color='#003d66', lw=line_width, label='middle age: 10500')
p.grid()
p.legend(loc='best')
p.xlabel('Time (years)')
